		...
		<div className="paste">
			<div className="paste__wrapper">
				<div className="paste__header">
					...
					<Link className="header__more-info" to={`/pastes/view/${props.name}`}>
						اطلاعات بیشتر
					</Link>
				</div>
					...
					<div className="code__features">
						<div className="features__right">
							<img
								...
								alt=""
							/>
							<Link to={`/pastes/view/${props.name}`}>
								<svg
									width="24"
									height="24"
									viewBox="0 0 20 20"
								...
								>
									<g>
										<g>
											<g>
												<path
													d="M490.667,85.333h-42.665H448h-68.675l-7.012-28.062C363.905,23.609,333.658,0,298.965,0h-85.931
				...
				L407.608,449.163z"
												/>
												<path
													d="M170.667,170.667c-11.782,0-21.333,9.551-21.333,21.333v213.333c0,11.782,9.551,21.333,21.333,21.333
				c11.782,0,21.333-9.551,21.333-21.333V192C192,180.218,182.449,170.667,170.667,170.667z"
												/>
												<path
													d="M256,170.667c-11.782,0-21.333,9.551-21.333,21.333v213.333c0,11.782,9.551,21.333,21.333,21.333
				s21.333-9.551,21.333-21.333V192C277.333,180.218,267.782,170.667,256,170.667z"
												/>
												<path
													d="M341.333,170.667C329.551,170.667,320,180.218,320,192v213.333c0,11.782,9.551,21.333,21.333,21.333
