...
const Header = (props) => {
	...
	return (
		<div className="navbar">
			...
			<div
				className="navbar__navigation navbar__navigation__responsive"
				style={{ display: "none" }}
			>
			...
			<div className="navbar__features">
				<Link className="features__new-paste" to="/new-paste">
					پیست جدید
				</Link>
				<img
					width="50px"
					...
					src={
						props.user.avatar
							? props.backend + "/avatars/" + props.user.avatar
							: "/images/guest.jpg"
					}
					alt=""
					...
					>
						{props.user.id ? (
							<div className="profile-dropdown__wrapper">
								...
								<div className="profile-dropdown__item">
									<Link to={"/accounts/view/" + props.user.username}>
										پروفایل
									</Link>
								</div>
							</div>
